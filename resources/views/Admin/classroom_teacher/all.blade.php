    ...
    <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
            <div class="page-header head-section">
                ...
                <div class="btn-group">
                    <a href="{{route('classroom_teacher.create',['name'=>$name])}}" class="btn btn-sm btn-primary">اضافه کردن معلم به کلاس</a>
                   </div>
                ...
                <table class="table table-striped table-bordered">
                    ...
                    @foreach($results as $result)
                        <tr>
                            ...
                            <td>
                                <form action="{{route('classroom_teacher.destroy',['name'=>$name,'id'=>$result->id])}}" method="post">
                                    {{method_field('delete')}}
                                    {{csrf_field()}}
