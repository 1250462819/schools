...
@section('content')
    <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
        <div class="page-header head-section">
            <h>کلاس های هر معلم را مشخص کنید</h>
        </div>
        <form class="form-horizontal" action="{{route('classroom_teacher.store',['name'=>$name])}}" method="post">
            {{csrf_field()}}
            @if(count($errors)>0)
            ...
            <div class="form-group">
                <div class="col-sm-12">
                    ...
                    <select class="form-control" name="classroom_id" id="classroom_id">
                        @foreach(\App\Classroom::latest()->get()->where('school.name','=', $name)->where('name','=',$class) as $classroom)
