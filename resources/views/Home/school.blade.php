        ...
        <div class="head">
            ...
            <div class="header-left">
                <div class="search-bar">
                    <input type="text" value="جستجو" onfocus="this.value = '';"
        ...
        <div class="about-main">
                    ...
                    @foreach($posts as $post)
                        <div class="a-1">
                            ...
                            <div class="col-md-6 abt-right">
                                <a href="$"><img src="/weblog/images/{{$post->pic}}" alt=""/></a>
            ...
            <div class="col-md-4 about-left heading">
                ...
                <div class="abt-2">
                    <h3>آرشیو</h3>
                    <ul>
                        <li><a href="single.html">لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با استفاده
                                از طراحان گرافیک است</a></li>
                        <li><a href="single.html">لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با استفاده
                                از طراحان گرافیک است</a></li>
                        <li><a href="single.html">لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با استفاده
                                از طراحان گرافیک است</a></li>
                ...
                <div class="abt-2">
                    ...
                    <div class="news">
                        <form>
                            <input type="text" value="ایمیل" onfocus="this.value = '';"
